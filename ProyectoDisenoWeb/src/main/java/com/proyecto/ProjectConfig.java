...
public class ProjectConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers("/facturar/carrito", "/carrito/orden", "/index", "/pedidos/listado", "/listaDeseos/listado","/listaDeseos/eliminar/*","/producto/vistaProducto/Mujer/Lifestyle", "/producto/vistaProducto/Hombre/*", "/producto/vistaProducto/Nin@",
