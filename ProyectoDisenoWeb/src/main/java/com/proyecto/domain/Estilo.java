...
public class Estilo implements Serializable { //serializacion porque se va almacenar ciertos datos en el disco
    ...
    @Column(name = "id_estilo") //decir cual es el nombre en la base de datos. Se hace la asociación 
